...
test(
  "visible paved lots are driveable while visible building masses stay solid",
  () => {
...
test(
  "traffic stays evenly spaced and perpendicular streams never share a junction core",
  () => {
